...
export async function getQuizPublicState(quizId: string) {
  ...
  return {
    ...
    photoWallBaseUrl: view.photoWallBaseUrl,
    photoWallImageCount: view.photoWallImageCount,
    photoWallImageExt: view.photoWallImageExt,
    photoWallTileVisible: view.photoWallTileVisible,
